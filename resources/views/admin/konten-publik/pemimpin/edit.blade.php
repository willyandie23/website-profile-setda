...
@section('title', 'Edit Pemimpin Daerah')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1">Edit Pemimpin Daerah</h1>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin.konten-publik.pemimpin.update', $pemimpin->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                               value="{{ old('nama', $pemimpin->nama) }}" placeholder="Contoh: Dr. H. AHMAD YANI, S.E., M.M." required>
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jabatan" class="form-control @error('jabatan') is-invalid @enderror"
                               value="{{ old('jabatan', $pemimpin->jabatan) }}" placeholder="Contoh: Bupati Katingan" required>
                        @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($pemimpin->foto)
                            <div class="mb-2 text-center">
                                ...
                                <p class="small text-muted mt-1 mb-0">Foto saat ini</p>
                            </div>
                        @endif

                        <input type="file" name="foto" class="form-control @error('foto') is-invalid @enderror"
                               accept=".png,.jpg,.jpeg,.webp" id="fotoInput">
                        <small class="text-muted d-block">Kosongkan jika tidak ingin mengubah foto. Format: PNG, JPG, JPEG, WEBP. Maksimal 5MB.</small>
                        ...
                        <div id="imagePreview" class="mt-3 d-none text-center">
                            ...
                            <p class="small text-muted mt-1 mb-0">Foto baru</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                                  rows="4" placeholder="Informasi singkat tentang pemimpin (opsional)">{{ old('deskripsi', $pemimpin->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="periode" class="form-control @error('periode') is-invalid @enderror"
                                       value="{{ old('periode', $pemimpin->periode) }}" placeholder="Contoh: 2024 - 2029">
                                @error('periode')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="urutan" class="form-control @error('urutan') is-invalid @enderror"
                                       value="{{ old('urutan', $pemimpin->urutan) }}" min="0">
                                @error('urutan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active"
                                   {{ old('is_active', $pemimpin->is_active) ? 'checked' : '' }}>
            ...
            <div class="card-body">
                <table class="table table-sm">
                    <tr>
                        ...
                        <td>{{ $pemimpin->created_at->format('d M Y H:i') }}</td>
                    </tr>
                    <tr>
                        <td class="text-muted">Diperbarui</td>
                        <td>{{ $pemimpin->updated_at->format('d M Y H:i') }}</td>
                    </tr>
                </table>
            </div>
        </div>
