...
<div class="content-wrapper">
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="page-subtitle">Buat akun administrator baru</p>
        </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                ...
                                <strong>Admin Biasa:</strong> Akses terbatas (tidak bisa kelola user & log)
                            </div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <div class="rounded-circle bg-light d-flex align-items-center justify-content-center mx-auto" style="width: 120px; height: 120px;" id="photoPreview">
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bi bi-check-lg me-1"></i> Simpan Admin
                        </button>
                    </div>
                </div>
            </div>
